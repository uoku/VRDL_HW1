...
def train(args, model):
    ...
    test_loader = torch.utils.data.DataLoader(image_datasets['validation'],
                                              batch_size=4,
                                              shuffle=False,
                                              num_workers=4)  # for Kaggle
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0]:
                    ...
                    writer.add_scalar(
                        "train/lr", scalar_value=scheduler.get_last_lr()[0], global_step=global_step)
...
def main():
    ...
    parser.add_argument("--eval_every", default=600, type=int,
